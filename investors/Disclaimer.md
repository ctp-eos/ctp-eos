**CTP Energy, LLC — Private Offering Notice & Corporate Position Statement**

CTP Energy, LLC (“the Company”) is a **privately held, independent deep technology venture** engaged in early-stage development of scientific platforms and applications under the emerging field of **CTP Energy Science** *(proprietary new private science)*. The Company is currently operating at the **pre-seed stage**, and no securities have been registered under the U.S. Securities Act of 1933 or any state securities laws.

This communication is **not an offer to sell or a solicitation of an offer to buy any securities** in the Company. Any such offering, if undertaken, will be conducted in reliance upon available exemptions from registration, including but not limited to those outlined in **Regulation D (Rule 506(b) or 506(c))**, and will be made only to individuals or entities who are **qualified as accredited investors** under SEC rules.  

CTP Energy, LLC **does not currently intend to pursue a public offering (IPO)** for itself or for its parent-level corporate structure. The Company is committed to remaining **independently operated**, and funding will be conducted through **private placements only**, unless otherwise required by law or regulation.

However, certain project-based subsidiaries or **Special Purpose Vehicles (SPVs)** affiliated with the Company—such as **CTP-EOS Linux**, **CTP Enterprise Linux**, or future CTP Energy applications in healing, communications, or aerospace—**may undergo public or semi-public funding rounds at future development stages**, including **crowdfunding** or **series equity offerings**. 
