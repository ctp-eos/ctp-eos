...
**CTP-EOS™ (The CTP Energy Operating System)** or the ***CTP Extraterretrial Operating System*** is a next-generation Linux distribution designed to integrate metaphysical sciences, advanced extraterrestrial research, and bleeding-edge post-quantum computing concepts. It is the first operating system built on the principles of **CTP Energy Science**—a radical framework exploring consciousness, non-locality, and intelligent design within energetic systems.

CTP-EOS™ is more than software. It is a transformational platform—**a bridge between conventional computation and metaphysical activation** *(for one's mind)*. Whether you're a designer, developer, mystic, or investor, **CTP-EOS™ is your entry point into the future of human evolution.**
...
* **2000s**: Conducted basic experiments and remote information transport
  - 2004 - Initial outreach to Nikola Tesla groups worldwide, proclaiming discovery of 'CTP'; the *non-physical science* and *greater energy* force Nikola Tesla never solved during his lifetime. All Tesla fan-groups met Drazen with dismissal or disregard.
  ...
  - 2006 - MySpace campaigns met with severe backlash, hostility, and contempt.
    - Two to four years looking for angels/capital for CTP.
    - Interest shown, however, no committing interests close.
    - *(Ontologiclal filters to CTP override most people's thinking processes - when first exposed)*
  ...
  - 2019 - Drazen passes in state ward ([*by then, Drazen was mentally broken after several years of hardships*](https://www.buzzfeednews.com/article/heidiblake/conservatorship-investigation-free-britney-spears)).  
...
**CTP Energy Science (CTPSci)** posits that all living systems interface with an intelligent, non-local energy field—the **C-domain** behind the creation of physical matter & energy. This domain is not bound by space-time but is instead structured around harmonic frequency states, intention, and universal syntax - above/outside physical quantum states.

* **Biocommunication** is not pseudoscience, but a measurable effect
* **Plants, humans and all living biological entities** all interact with C-domain data via the C-body.
* **Software can *(eventually)* be designed to engage this layer** of intelligent causality

**CTP-EOS™ is the first operating system that will entrain the mind to further ***interface*** with this C-domain layer.**
...
Part II part will be your rather 'standard' and 'branded' multi-format based Linux distribution,
...
**CTP-EOS™** is a secure, multi-format based operating system inspired by **Qubes OS**, **Tiling Window Managers**, and **CTP Energy Science** system-level requirements. CTP-EOS is the ***Disclosure Linux*** distro suite. We will deploy ISOs in **Debian/Ubuntu** AND **Arch** Linux formats. For new Linux users to seasoned Linux pros - **CTP-EOS™** will offer Linux formats for all user types and skill-levels.
...
![Linux](https://img.shields.io/badge/platform-Linux-FCC624?logo=linux&logoColor=black) ![Linux Kernel](https://img.shields.io/badge/kernel-Linux_6.x-FCC624?logo=linux&logoColor=black) ![Linux OS](https://img.shields.io/badge/Linux-Open_Source_OS-black?logo=tux&logoColor=white) ![Platform](https://img.shields.io/badge/platform-Arch_Linux-1793D1?logo=arch-linux&logoColor=white)  ![Built for Linux](https://img.shields.io/badge/Built_for-Linux-FCC624?logo=linux&logoColor=black) ![Powered by Linux](https://img.shields.io/badge/Powered_by-Linux-FCC624?logo=linux&logoColor=black) ![Conscious Stack](https://img.shields.io/badge/Linux-Conscious_Stack-44cc88?logo=linux&logoColor=white) ![awesome](https://img.shields.io/badge/WM-awesome-5277C3?logo=awesomewm&logoColor=white) ![bspwm](https://img.shields.io/badge/WM-bspwm-CA2C92?logo=window-manager&logoColor=white) ![Budgie](https://img.shields.io/badge/Desktop-Budgie-5A5CFF?logo=solus&logoColor=white) ![Cinnamon](https://img.shields.io/badge/Desktop-Cinnamon-8B1C62?logo=linuxmint&logoColor=white) ![GNOME](https://img.shields.io/badge/Desktop-GNOME-4A86CF?logo=gnome&logoColor=white) ![i3](https://img.shields.io/badge/WM-i3-478061?logo=i3&logoColor=white) ![LXQt](https://img.shields.io/badge/Desktop-LXQt-0094D4?logo=lxde&logoColor=white) ![qtile](https://img.shields.io/badge/WM-qtile-44AA99?logo=python&logoColor=white) ![XFCE](https://img.shields.io/badge/Desktop-XFCE-blue?logo=xfce&logoColor=white) ![ZWM](https://img.shields.io/badge/WM-ZWM_CTP_Custom-8E44AD?logo=cosmos&logoColor=white) ![Calamares](https://img.shields.io/badge/Installer-Calamares-green) ![Status](https://img.shields.io/badge/status-in_development-yellow) [![Website](https://img.shields.io/badge/website-ctpeos.org-blue)](https://ctpeos.org)
 ![Contrib](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat) ![MadeWithLove](https://img.shields.io/badge/Made%20with-%E2%9D%A4-red)
...
![Conscious Assisted Technologies](https://img.shields.io/badge/Conscious_Assisted_Technologies-Neural_Awareness-yellowgreen?logo=eye&logoColor=white)
